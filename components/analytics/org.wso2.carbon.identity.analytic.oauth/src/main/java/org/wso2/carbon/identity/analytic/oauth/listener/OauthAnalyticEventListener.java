...
package org.wso2.carbon.identity.analytic.oauth.listener;

import org.wso2.carbon.identity.analytic.oauth.OauthDataPublisher;
...
public class OauthAnalyticEventListener implements OauthEventListener {


    private OauthDataPublisher dataPublisher;

    public OauthAnalyticEventListener() {
    ...
    public void onPostTokenIssue(OAuth2AccessTokenReqDTO tokenReqDTO, OAuth2AccessTokenRespDTO tokenRespDTO,
        ...
        List<String> grantedScopes = Arrays.asList(tokenRespDTO.getAuthorizedScopes().split(" "));
