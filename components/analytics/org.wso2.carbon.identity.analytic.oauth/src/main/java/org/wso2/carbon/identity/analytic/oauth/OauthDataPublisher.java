...
package org.wso2.carbon.identity.analytic.oauth;

import org.wso2.carbon.databridge.commons.Event;
import org.wso2.carbon.identity.analytic.core.EventPublisherService;
import org.wso2.carbon.identity.analytic.oauth.internal.OauthAnalyticServiceHolder;
...
public class OauthDataPublisher {
    ...
    public OauthDataPublisher() {
        ...
        publisher = OauthAnalyticServiceHolder.getInstance().getPublisherService();
    }
